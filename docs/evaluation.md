...
### Thời điểm Kích hoạt
Khi bạn nhấp "Kết thúc trò chuyện", hệ thống sẽ:
...
## 3. Đánh giá Từng câu
Cấp độ phản hồi chi tiết nhất, phân tích từng tin nhắn của bạn đang diễn ra.

### Cách thức Hoạt động
Tính năng này chạy ngầm trong suốt buổi thực hành. Khi bạn chuyển sang tab Đánh giá Từng câu, bạn có thể xem lại "Suy nghĩ nội tâm của AI" (điều khách hàng đang thực sự nghĩ) và các phản hồi chi tiết cho từng tin nhắn (cách diễn đạt, hiệu quả sử dụng kỹ năng).
...
4. Nhấc tab **Đánh giá Từng câu** và chú ý phần **Suy nghĩ nội tâm của AI** để thấu hiểu tâm lý khách hàng.
